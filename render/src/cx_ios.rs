...
impl Cx {
    ...
    {
        self.platform_type = PlatformType::IOS;
        ...
        cocoa_app.event_loop(|_cocoa_app, _events| {
            // Skipping all
            true
        });
        ...
        //                             if let Some(main_pass_id) =
        //                                 self.windows[re.window_id].main_pass_id
        //                             {
        ...
        //                     cocoa_app
        //                         .set_mouse_cursor(self.down_mouse_cursor.as_ref().unwrap().clone())
        //                 } else if !self.hover_mouse_cursor.is_none() {
        //                     cocoa_app
        //                         .set_mouse_cursor(self.hover_mouse_cursor.as_ref().unwrap().clone())
        //                 } else {
        ...
        //                     let (timer_id, interval, repeats) =
        //                         self.platform.start_timer.pop().unwrap();
        ...
        //                                         metal_window.set_vsync_enable(
        //                                             windows_need_repaint == 0 && vsync,
        //                                         );
        //                                         metal_window.set_buffer_count(
        //                                             if metal_window.window_geom.is_fullscreen {
        //                                                 3
        //                                             } else {
        //                                                 2
        //                                             },
        ...
        //                                 let dpi_factor =
        //                                     self.get_delegated_dpi_factor(parent_pass_id);
        //                                 self.passes[*pass_id].set_dpi_factor(dpi_factor);
    ...
    pub fn start_timer(&mut self, interval: f64, repeats: bool) -> Timer {
        ...
        self.platform
            .start_timer
            .push((self.timer_id, interval, repeats));
        Timer {
